...
*  ![image-20220819214400493](/Users/ysk/study/study_repo/10분 테코톡/images//image-20220819214400493.png)
* 출처 : 위키
...
2. View에서 일어나는 과한 값 검증과 예외처리
   ...
   * Input 값은 Presentaion Layer에서 체크한다
     * InputView에 값의 입력 외에 다른 역할을 부여하면 [단일 책임 원칙](####단일-책임-원칙-(SRP,-Sigle-Responsibillity-Principle))에 위반되어 추후에 입력 채널이 달라질 경우 유효성 체크로직도 다른 채널로 옮겨가야 한다. 
