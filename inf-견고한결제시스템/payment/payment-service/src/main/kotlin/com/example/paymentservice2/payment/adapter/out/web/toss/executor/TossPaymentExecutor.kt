...
import com.example.paymentservice2.payment.adapter.out.web.toss.response.TossFailureResponse
import com.example.paymentservice2.payment.adapter.out.web.toss.response.TossPaymentConfirmationResponse
...
class TossPaymentExecutor(
    ...
    override fun execute(command: PaymentConfirmCommand): Mono<PaymentExecutionResult> {
      ...
      """.trimIndent()
            ...
            .retryWhen(Retry.backoff(2, Duration.ofSeconds(1)) // 최대 2회. 백오프 1초. 변동성(지터) 0.1
                .jitter(0.1)
