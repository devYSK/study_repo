...
public class CacheConfig {
	...
	public RedisCacheManagerBuilderCustomizer redisCacheManagerBuilderCustomizer() {
		...
		List<CacheProperty> properties = List.of(
			new CacheProperty(CACHE_NAME1, 300),
			new CacheProperty(CACHE_NAME2, 30)
		);

		return (builder -> properties.forEach(i -> builder.withCacheConfiguration(i.getName(), RedisCacheConfiguration
			.defaultCacheConfig()
