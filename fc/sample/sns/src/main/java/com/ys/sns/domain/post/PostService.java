...
import com.ys.sns.domain.post.repository.CommentEntityRepository;
import com.ys.sns.domain.post.repository.LikeEntityRepository;
...
public class PostService {
	...
	public void comment(Integer postId, String userName, String comment) {
		...
		// alarmProducer.send(new AlarmEvent(AlarmType.NEW_COMMENT_ON_POST, new AlarmArgs(userEntity.getId(), postId),
		// 	postEntity.getUser()
		// 		.getId()));

		applicationEventPublisher.publishEvent(
			(new AlarmEvent(AlarmType.NEW_COMMENT_ON_POST, new AlarmArgs(userEntity.getId(), postId),
				postEntity.getUser()
					.getId())));
	}
	...
	public void like(Integer postId, String userName) {
		...
		// alarmProducer.send(new AlarmEvent(AlarmType.NEW_LIKE_ON_POST, new AlarmArgs(userEntity.getId(), postId),
		// 	postEntity.getUser()
		// 		.getId()));
		applicationEventPublisher.publishEvent(new AlarmEvent(AlarmType.NEW_LIKE_ON_POST, new AlarmArgs(userEntity.getId(), postId),
			postEntity.getUser()
				.getId()));
	}
